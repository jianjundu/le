package com.le.jr.am.profit.domain.constant;
...
public class SysConstant {
	 ...
	 * 是否通知派息成功
	 */
	public static final String AM_PROFIT_NOTIFYALLOTINTEREST_SUCCESS="am_profit_notifyallotinterest_success:";
	
	
	public static final String AM_PROFIT_PRODUCTCONTRACTMODEL = "am_profit_productcontractmodel_";
